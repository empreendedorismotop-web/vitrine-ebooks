...
type MeuAnuncio = {
  ...
  link_curto?: string
  cliques?: Clique[]
  favoritos_count?: number // NOVO: Campo de favoritos para exibir as curtidas
}
        ...
        {telaAtiva === 'lista' && anuncios.map(anuncio => (
            <div key={anuncio.id} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 mb-4 flex flex-col hover:shadow-md transition-shadow">
                ...
                <div className="mt-4 pt-4 border-t border-slate-100 flex flex-wrap items-center gap-4">
                  ...
                  {/* NOVO: Badge Favoritos Recebidos */}
                  <div className="bg-red-50 border border-red-100 text-red-600 px-3 py-1.5 rounded-lg text-sm font-bold flex items-center gap-2 shadow-sm">
                    <Heart className="size-4 fill-red-500 text-red-500" /> 
                    {anuncio.favoritos_count || 0} Favoritos
                  </div>
